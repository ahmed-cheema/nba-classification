...
db = pd.read_csv('C:\\Users\\cheem\\Python Scripts\\CSV\\player_clusters.csv')
...
db.columns = ['PLAYER_NAME','SEASON','cluster','position','ID14','ID15','ID16','ID17','ID18','ID19','ID20']
...
db = db[['PLAYER_NAME','PLAYER_ID','SEASON','cluster','position']]

################################################## GET PLAYER_IDS, TEAM NET RATINGS, CLUSTERS

tf = pd.merge(df,db[['PLAYER_ID','SEASON','PLAYER_NAME','position']],left_on=['id1','SEASON'],right_on=['PLAYER_ID','SEASON'])

tf = pd.merge(tf,db[['PLAYER_ID','SEASON','PLAYER_NAME','position']],left_on=['id2','SEASON'],right_on=['PLAYER_ID','SEASON'])

tf = pd.merge(tf,db[['PLAYER_ID','SEASON','PLAYER_NAME','position']],left_on=['id3','SEASON'],right_on=['PLAYER_ID','SEASON'])

tf = pd.merge(tf,db[['PLAYER_ID','SEASON','PLAYER_NAME','position']],left_on=['id4','SEASON'],right_on=['PLAYER_ID','SEASON'])

tf = pd.merge(tf,db[['PLAYER_ID','SEASON','PLAYER_NAME','position']],left_on=['id5','SEASON'],right_on=['PLAYER_ID','SEASON'])
